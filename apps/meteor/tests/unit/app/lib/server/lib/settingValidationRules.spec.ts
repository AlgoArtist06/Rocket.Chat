...
const { validateSettingRules, SettingValidationError } = p
	.noCallThru()
	.load('../../../../../../app/lib/server/lib/settingValidationRules.ts', {
		'../../../../server/lib/logger/system': { SystemLogger: { error: systemLoggerErrorMock } },
		'../../../settings/server': { settings: { get: settingsGetMock, getSetting: settingsGetSettingMock } },
	});
